...
@objc class rTSP_NN:NSObject
{
   ...
   @objc func setkoordinaten(koord:[[Double]])
   {
      var zeilenindex = 0
      plan.removeAll()
      weg.removeAll()
   ...
   @objc func entfernung(a:Int, b:Int)->Double
   {
   ...
   @objc func nextmillpunkt(aktuellerpunkt:Int)->(Int)
   {
